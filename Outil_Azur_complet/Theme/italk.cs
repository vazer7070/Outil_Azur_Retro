    ...
    class iTalk_Button_3 : Control
    {
        ...
        protected override void OnResize(System.EventArgs e)
        {
            ...
            if (Width > 0 && Height > 0)
            {
                ...
                InactiveGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(243, 162, 22), Color.FromArgb(243, 162, 22), 90f);
                PressedGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(233, 154, 18), Color.FromArgb(233, 154, 18), 90f);
                PressedContourGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(243, 162, 22), Color.FromArgb(243, 162, 22), 90f);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (Bitmap bitmap = new Bitmap(this.Width, this.Height))
            {
                using (Graphics graphics = Graphics.FromImage(bitmap))
                {
                    ...
                    SizeF MS = graphics.MeasureString(Convert.ToString(Convert.ToInt64((100 / _Maximum) * _Value)), Font);
                    graphics.DrawString(Convert.ToString(Convert.ToInt64((100 / _Maximum) * _Value)), Font, Brushes.White, Convert.ToInt64(Width / 2 - MS.Width / 2), Convert.ToInt64(Height / 2 - MS.Height / 2));
